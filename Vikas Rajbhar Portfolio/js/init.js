...
function iknow_tm_menu_width() {
    ...
    btn.on('mouseenter', function() {
        ...
        if (activeLi.length) {
            ...
            activeLi.removeClass('fixed').addClass('active').css({
                width: elWidth + textWidth + 'px'
            });
        }
    });
    btn.on('click', function() {
        ...
        li.siblings().removeClass('active').css({
            width: '135px'
        });
        if (ww <= 1400) {
            li.siblings().removeClass('active').css({
...
function iknow_tm_menu_width_action(element, action) {
    ...
    if (action === 'active') {
        ...
        if (activeLi.length) {
            ...
            var textWidth = activeLi.find('span').outerWidth();
            activeLi.removeClass('fixed').addClass('current').css({
                width: elWidth + textWidth + 'px'
            });
        }
    }
...
function iknow_tm_menu_width_new() {
    ...
    btn.on('click', function() {
        ...
        li.siblings().removeClass('current').css({
            width: '70px'
        });
        if (ww <= 1400) {
            li.siblings().removeClass('current').css({
...
function iknow_tm_scrollable() {
    ...
    if (WW <= 1400) {
        verMenu.css({
            height: H - topbar - image - footerHeight
        });
    }
    verMenu.css({
        height: H - topbar - image - footerHeight - 90
    });
    if (WW <= 1400) {
